...
public class DemoWebsocketClient {
    ...
    public static final String SEND_URL = GlobalConstants.APP_PREFIX + GlobalConstants.HELLO_MAPPING;
    ...
    static public class MyStompSessionHandler extends StompSessionHandlerAdapter {
        ...
        public void afterConnected(StompSession session, StompHeaders connectedHeaders) {
            ...
            subscribeTopic(GlobalConstants.TOPIC, session);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String url = "ws://localhost:8080" + GlobalConstants.ENDPOINT;
